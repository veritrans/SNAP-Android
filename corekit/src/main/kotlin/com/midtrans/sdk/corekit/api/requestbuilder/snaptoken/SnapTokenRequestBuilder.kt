...
class SnapTokenRequestBuilder {
    ...
    private var transactionDetails: SnapTransactionDetail? = null
    ...
    private var gopayCallback: PaymentCallback? = null
    ...
    fun withGopayCallback(value: PaymentCallback) = apply { gopayCallback = value }
