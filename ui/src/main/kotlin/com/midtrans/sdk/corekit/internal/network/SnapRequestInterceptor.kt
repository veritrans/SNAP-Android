...
internal class SnapRequestInterceptor : Interceptor {
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        var headerIdentifier = "mobile-android"

        if (SnapCore.getInstance()?.isSnapTokenFlow == false) {
            headerIdentifier = "mobile-android/sdk-flow"
        }

        return chain.proceed(
            request.newBuilder()
                .addHeader("X-Source", headerIdentifier)
