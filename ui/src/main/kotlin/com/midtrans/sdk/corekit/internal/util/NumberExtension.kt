...
internal fun Int.toSignedByteArray(): ByteArray {
...
internal fun Int.toBytesLittleEndian(): ByteArray {
    return ByteBuffer
...
internal fun Int.toStringWithLeftZeroPadding(digit: Int): String{
